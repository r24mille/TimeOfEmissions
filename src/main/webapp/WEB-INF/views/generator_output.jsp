...
<!DOCTYPE html>
<html class="no-js">
<toe:head pageTitle="Generator Output" description="Electricity generation by fuel type"/>
<body>
	<toe:pageHeader/>
	<toe:pageContent>
			...
			<article>
				...
				<section>
					...
					<script>
						...
						$("div#agg_gen_chart div.top_legend")
						.append("<ul class=\"top_legend_row\"><li class=\"plot_line gas_line_nodot\">Gas</li><li class=\"plot_line coal_line_nodot\">Coal</li><li class=\"plot_line other_line_nodot\">Other</li></ul>");
					</script>
				</section>
				<section>
					<h2>
